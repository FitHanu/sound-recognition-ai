...
import com.example.jetnews.ui.recorder.RecorderRoute
import com.example.jetnews.ui.recorder.RecorderViewModel
...
fun JetnewsNavGraph(
    ...
    NavHost(
        ...
        composable(JetnewsDestinations.RECORDER_ROUTE) {
            val interestsViewModel: RecorderViewModel = viewModel(
                factory = RecorderViewModel.provideFactory(appContainer.classifierRepository)
            )
            RecorderRoute(
                isExpandedScreen = isExpandedScreen,
                openDrawer = openDrawer
